...
def auto_parallel(
    ...
    *,
    ...
    The returned module runs eagerly. For compiled execution, wrap with
    torch.compile() and use autoparallel.compile.inductor_config() to
    configure AP-optimized Inductor passes.
